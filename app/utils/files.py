...
@tool
def write_file(file_path: Optional[str] = None, path: Optional[str] = None, text: Optional[str] = None, content: Optional[str] = None, directorio: str = "./") -> str:
    """
...
@tool
def read_file(file_path: Optional[str] = None, path: Optional[str] = None, directorio: str = "./") -> str:
    """
...
@tool
def list_directory(dir_path: Optional[str] = None, path: Optional[str] = None, directorio: str = "./") -> str:
    """
...
@tool
def file_delete(file_path: Optional[str] = None, path: Optional[str] = None, directorio: str = "./") -> str:
    """
...
@tool
def copy_file(source_path: Optional[str] = None, source: Optional[str] = None, destination_path: Optional[str] = None, destination: Optional[str] = None, dest: Optional[str] = None, directorio: str = "./") -> str:
    """
...
@tool
def move_file(source_path: Optional[str] = None, source: Optional[str] = None, destination_path: Optional[str] = None, destination: Optional[str] = None, dest: Optional[str] = None, directorio: str = "./") -> str:
    """
...
def get_custom_file_tools(directorio: str):
    ...
    vinculadas al directorio de proyecto especificado.
    """
